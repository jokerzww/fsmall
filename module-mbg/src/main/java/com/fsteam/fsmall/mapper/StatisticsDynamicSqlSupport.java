...
public final class StatisticsDynamicSqlSupport {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4901617+08:00", comments="Source field: STATISTICS.TABLE_CATALOG")
    public static final SqlColumn<String> tableCatalog = statistics.tableCatalog;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4901617+08:00", comments="Source field: STATISTICS.TABLE_SCHEMA")
    public static final SqlColumn<String> tableSchema = statistics.tableSchema;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4901617+08:00", comments="Source field: STATISTICS.TABLE_NAME")
    public static final SqlColumn<String> tableName = statistics.tableName;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4901617+08:00", comments="Source field: STATISTICS.NON_UNIQUE")
    public static final SqlColumn<Integer> nonUnique = statistics.nonUnique;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4901617+08:00", comments="Source field: STATISTICS.INDEX_SCHEMA")
    public static final SqlColumn<String> indexSchema = statistics.indexSchema;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4901617+08:00", comments="Source field: STATISTICS.INDEX_NAME")
    public static final SqlColumn<String> indexName = statistics.indexName;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4901617+08:00", comments="Source field: STATISTICS.SEQ_IN_INDEX")
    public static final SqlColumn<Integer> seqInIndex = statistics.seqInIndex;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4901617+08:00", comments="Source field: STATISTICS.COLUMN_NAME")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4911628+08:00", comments="Source field: STATISTICS.EXPRESSION")
