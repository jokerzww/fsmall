...
import static com.fsteam.fsmall.mapper.InnodbTrxDynamicSqlSupport.*;

import com.fsteam.fsmall.model.InnodbTrx;
...
public interface InnodbTrxMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.0627718+08:00", comments="Source Table: INNODB_TRX")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.0617706+08:00", comments="Source Table: INNODB_TRX")
    ...
    @Results(id="InnodbTrxResult", value = {
        ...
        @Result(column="trx_schedule_weight", property="trxScheduleWeight", jdbcType=JdbcType.BIGINT)
    })
    ...
    default int insert(InnodbTrx record) {
        return MyBatis3Utils.insert(this::insert, record, innodbTrx, c ->
            ...
            .map(trxScheduleWeight).toProperty("trxScheduleWeight")
        );
    }
    ...
    default int insertSelective(InnodbTrx record) {
        return MyBatis3Utils.insert(this::insert, record, innodbTrx, c ->
            ...
            .map(trxScheduleWeight).toPropertyWhenPresent("trxScheduleWeight", record::getTrxScheduleWeight)
        );
    }
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(InnodbTrx record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(trxId).equalTo(record::getTrxId)
                ...
                .set(trxScheduleWeight).equalTo(record::getTrxScheduleWeight);
    }
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(InnodbTrx record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(trxId).equalToWhenPresent(record::getTrxId)
                ...
                .set(trxScheduleWeight).equalToWhenPresent(record::getTrxScheduleWeight);
    }
}