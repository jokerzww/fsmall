...
import static com.fsteam.fsmall.mapper.FilesDynamicSqlSupport.*;

import com.fsteam.fsmall.model.Files;
...
public interface FilesMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3430275+08:00", comments="Source Table: FILES")
    BasicColumn[] selectList = BasicColumn.columnList(fileId, fileType, tablespaceName, tableCatalog, logfileGroupName, logfileGroupNumber, engine, freeExtents, totalExtents, extentSize, initialSize, maximumSize, autoextendSize, version, rowFormat, dataFree, status, extra, fileName, tableSchema, tableName, fulltextKeys, deletedRows, updateCount, creationTime, lastUpdateTime, lastAccessTime, recoverTime, transactionCounter, tableRows, avgRowLength, dataLength, maxDataLength, indexLength, createTime, updateTime, checkTime, checksum);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3420259+08:00", comments="Source Table: FILES")
