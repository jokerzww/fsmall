...
import static com.fsteam.fsmall.mapper.SchemaTableStatisticsWithBufferDynamicSqlSupport.*;

import com.fsteam.fsmall.model.SchemaTableStatisticsWithBuffer;
...
public interface SchemaTableStatisticsWithBufferMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    ...
    int insert(InsertStatementProvider<SchemaTableStatisticsWithBuffer> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("SchemaTableStatisticsWithBufferResult")
    Optional<SchemaTableStatisticsWithBuffer> selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="SchemaTableStatisticsWithBufferResult", value = {
        ...
        @Result(column="fetch_latency", property="fetchLatency", jdbcType=JdbcType.VARCHAR),
        @Result(column="rows_inserted", property="rowsInserted", jdbcType=JdbcType.BIGINT),
        @Result(column="insert_latency", property="insertLatency", jdbcType=JdbcType.VARCHAR),
        @Result(column="rows_updated", property="rowsUpdated", jdbcType=JdbcType.BIGINT),
        @Result(column="update_latency", property="updateLatency", jdbcType=JdbcType.VARCHAR),
        @Result(column="rows_deleted", property="rowsDeleted", jdbcType=JdbcType.BIGINT),
        @Result(column="delete_latency", property="deleteLatency", jdbcType=JdbcType.VARCHAR),
        @Result(column="io_read_requests", property="ioReadRequests", jdbcType=JdbcType.DECIMAL),
        @Result(column="io_read", property="ioRead", jdbcType=JdbcType.VARCHAR),
        @Result(column="io_read_latency", property="ioReadLatency", jdbcType=JdbcType.VARCHAR),
        @Result(column="io_write_requests", property="ioWriteRequests", jdbcType=JdbcType.DECIMAL),
        @Result(column="io_write", property="ioWrite", jdbcType=JdbcType.VARCHAR),
        @Result(column="io_write_latency", property="ioWriteLatency", jdbcType=JdbcType.VARCHAR),
        @Result(column="io_misc_requests", property="ioMiscRequests", jdbcType=JdbcType.DECIMAL),
        @Result(column="io_misc_latency", property="ioMiscLatency", jdbcType=JdbcType.VARCHAR),
        @Result(column="innodb_buffer_allocated", property="innodbBufferAllocated", jdbcType=JdbcType.VARCHAR),
        @Result(column="innodb_buffer_data", property="innodbBufferData", jdbcType=JdbcType.VARCHAR),
        @Result(column="innodb_buffer_free", property="innodbBufferFree", jdbcType=JdbcType.VARCHAR),
    ...
    List<SchemaTableStatisticsWithBuffer> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, schemaTableStatisticsWithBuffer, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, schemaTableStatisticsWithBuffer, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    default int insert(SchemaTableStatisticsWithBuffer record) {
        return MyBatis3Utils.insert(this::insert, record, schemaTableStatisticsWithBuffer, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    default int insertSelective(SchemaTableStatisticsWithBuffer record) {
        return MyBatis3Utils.insert(this::insert, record, schemaTableStatisticsWithBuffer, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    default Optional<SchemaTableStatisticsWithBuffer> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, schemaTableStatisticsWithBuffer, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    default List<SchemaTableStatisticsWithBuffer> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, schemaTableStatisticsWithBuffer, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    default List<SchemaTableStatisticsWithBuffer> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, schemaTableStatisticsWithBuffer, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, schemaTableStatisticsWithBuffer, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    static UpdateDSL<UpdateModel> updateAllColumns(SchemaTableStatisticsWithBuffer record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1268299+08:00", comments="Source Table: schema_table_statistics_with_buffer")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(SchemaTableStatisticsWithBuffer record, UpdateDSL<UpdateModel> dsl) {
