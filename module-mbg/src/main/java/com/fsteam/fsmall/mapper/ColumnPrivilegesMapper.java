...
import static com.fsteam.fsmall.mapper.ColumnPrivilegesDynamicSqlSupport.*;

import com.fsteam.fsmall.model.ColumnPrivileges;
...
public interface ColumnPrivilegesMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    BasicColumn[] selectList = BasicColumn.columnList(grantee, tableCatalog, tableSchema, tableName, columnName, privilegeType, isGrantable);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2059038+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    ...
    int insert(InsertStatementProvider<ColumnPrivileges> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("ColumnPrivilegesResult")
    Optional<ColumnPrivileges> selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="ColumnPrivilegesResult", value = {
    ...
    List<ColumnPrivileges> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, columnPrivileges, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, columnPrivileges, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    default int insert(ColumnPrivileges record) {
        return MyBatis3Utils.insert(this::insert, record, columnPrivileges, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    default int insertSelective(ColumnPrivileges record) {
        return MyBatis3Utils.insert(this::insert, record, columnPrivileges, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    default Optional<ColumnPrivileges> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, columnPrivileges, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    default List<ColumnPrivileges> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, columnPrivileges, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    default List<ColumnPrivileges> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, columnPrivileges, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, columnPrivileges, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    static UpdateDSL<UpdateModel> updateAllColumns(ColumnPrivileges record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2069042+08:00", comments="Source Table: COLUMN_PRIVILEGES")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(ColumnPrivileges record, UpdateDSL<UpdateModel> dsl) {
