...
import static com.fsteam.fsmall.mapper.SchemaIndexStatisticsDynamicSqlSupport.*;

import com.fsteam.fsmall.model.SchemaIndexStatistics;
...
public interface SchemaIndexStatisticsMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1088137+08:00", comments="Source Table: schema_index_statistics")
    ...
    int insert(InsertStatementProvider<SchemaIndexStatistics> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1088137+08:00", comments="Source Table: schema_index_statistics")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("SchemaIndexStatisticsResult")
    Optional<SchemaIndexStatistics> selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1088137+08:00", comments="Source Table: schema_index_statistics")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="SchemaIndexStatisticsResult", value = {
        ...
        @Result(column="select_latency", property="selectLatency", jdbcType=JdbcType.VARCHAR),
    ...
    List<SchemaIndexStatistics> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, schemaIndexStatistics, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1088137+08:00", comments="Source Table: schema_index_statistics")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, schemaIndexStatistics, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1088137+08:00", comments="Source Table: schema_index_statistics")
    default int insert(SchemaIndexStatistics record) {
        return MyBatis3Utils.insert(this::insert, record, schemaIndexStatistics, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1088137+08:00", comments="Source Table: schema_index_statistics")
    default int insertSelective(SchemaIndexStatistics record) {
        return MyBatis3Utils.insert(this::insert, record, schemaIndexStatistics, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1088137+08:00", comments="Source Table: schema_index_statistics")
    default Optional<SchemaIndexStatistics> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, schemaIndexStatistics, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1088137+08:00", comments="Source Table: schema_index_statistics")
    default List<SchemaIndexStatistics> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, schemaIndexStatistics, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1088137+08:00", comments="Source Table: schema_index_statistics")
    default List<SchemaIndexStatistics> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, schemaIndexStatistics, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1088137+08:00", comments="Source Table: schema_index_statistics")
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, schemaIndexStatistics, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1098161+08:00", comments="Source Table: schema_index_statistics")
    static UpdateDSL<UpdateModel> updateAllColumns(SchemaIndexStatistics record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1098161+08:00", comments="Source Table: schema_index_statistics")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(SchemaIndexStatistics record, UpdateDSL<UpdateModel> dsl) {
