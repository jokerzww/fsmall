...
public final class InnodbSessionTempTablespacesDynamicSqlSupport {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3630463+08:00", comments="Source field: INNODB_SESSION_TEMP_TABLESPACES.ID")
    public static final SqlColumn<Integer> id = innodbSessionTempTablespaces.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3630463+08:00", comments="Source field: INNODB_SESSION_TEMP_TABLESPACES.SPACE")
    public static final SqlColumn<Integer> space = innodbSessionTempTablespaces.space;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3630463+08:00", comments="Source field: INNODB_SESSION_TEMP_TABLESPACES.PATH")
    public static final SqlColumn<String> path = innodbSessionTempTablespaces.path;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3630463+08:00", comments="Source field: INNODB_SESSION_TEMP_TABLESPACES.SIZE")
    public static final SqlColumn<Long> size = innodbSessionTempTablespaces.size;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3630463+08:00", comments="Source field: INNODB_SESSION_TEMP_TABLESPACES.STATE")
    public static final SqlColumn<String> state = innodbSessionTempTablespaces.state;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3630463+08:00", comments="Source field: INNODB_SESSION_TEMP_TABLESPACES.PURPOSE")
