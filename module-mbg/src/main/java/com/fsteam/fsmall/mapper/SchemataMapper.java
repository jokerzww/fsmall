...
import static com.fsteam.fsmall.mapper.SchemataDynamicSqlSupport.*;

import com.fsteam.fsmall.model.Schemata;
...
public interface SchemataMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(catalogName, schemaName, defaultCharacterSetName, defaultCollationName, defaultEncryption, sqlPath);
    ...
    @Results(id="SchemataResult", value = {
        ...
        @Result(column="DEFAULT_ENCRYPTION", property="defaultEncryption", jdbcType=JdbcType.CHAR),
    ...
    default int insert(Schemata record) {
        return MyBatis3Utils.insert(this::insert, record, schemata, c ->
            ...
            .map(defaultEncryption).toProperty("defaultEncryption")
    ...
    default int insertSelective(Schemata record) {
        return MyBatis3Utils.insert(this::insert, record, schemata, c ->
            ...
            .map(defaultEncryption).toPropertyWhenPresent("defaultEncryption", record::getDefaultEncryption)
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(Schemata record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(catalogName).equalTo(record::getCatalogName)
                ...
                .set(defaultEncryption).equalTo(record::getDefaultEncryption)
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(Schemata record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(catalogName).equalToWhenPresent(record::getCatalogName)
                ...
                .set(defaultEncryption).equalToWhenPresent(record::getDefaultEncryption)
