...
import static com.fsteam.fsmall.mapper.TableConstraintsDynamicSqlSupport.*;

import com.fsteam.fsmall.model.TableConstraints;
...
public interface TableConstraintsMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1148227+08:00", comments="Source Table: TABLE_CONSTRAINTS")
    BasicColumn[] selectList = BasicColumn.columnList(constraintCatalog, constraintSchema, constraintName, tableSchema, tableName, constraintType, enforced);
    ...
    @Results(id="TableConstraintsResult", value = {
        ...
        @Result(column="ENFORCED", property="enforced", jdbcType=JdbcType.VARCHAR)
    })
