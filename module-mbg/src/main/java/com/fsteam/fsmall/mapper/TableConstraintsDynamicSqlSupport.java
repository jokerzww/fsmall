...
public final class TableConstraintsDynamicSqlSupport {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1148227+08:00", comments="Source field: TABLE_CONSTRAINTS.TABLE_SCHEMA")
    public static final SqlColumn<String> tableSchema = tableConstraints.tableSchema;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1148227+08:00", comments="Source field: TABLE_CONSTRAINTS.TABLE_NAME")
    public static final SqlColumn<String> tableName = tableConstraints.tableName;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1148227+08:00", comments="Source field: TABLE_CONSTRAINTS.CONSTRAINT_TYPE")
    public static final SqlColumn<String> constraintType = tableConstraints.constraintType;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1148227+08:00", comments="Source field: TABLE_CONSTRAINTS.ENFORCED")
    public static final SqlColumn<String> enforced = tableConstraints.enforced;
    ...
    public static final class TableConstraints extends SqlTable {
        ...
        public final SqlColumn<String> enforced = column("ENFORCED", JDBCType.VARCHAR);
