...
public final class InnodbTablespacesDynamicSqlSupport {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2949831+08:00", comments="Source field: INNODB_TABLESPACES.SPACE_TYPE")
    public static final SqlColumn<String> spaceType = innodbTablespaces.spaceType;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2949831+08:00", comments="Source field: INNODB_TABLESPACES.FS_BLOCK_SIZE")
    public static final SqlColumn<Integer> fsBlockSize = innodbTablespaces.fsBlockSize;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2949831+08:00", comments="Source field: INNODB_TABLESPACES.FILE_SIZE")
    public static final SqlColumn<Long> fileSize = innodbTablespaces.fileSize;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2949831+08:00", comments="Source field: INNODB_TABLESPACES.ALLOCATED_SIZE")
    public static final SqlColumn<Long> allocatedSize = innodbTablespaces.allocatedSize;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2949831+08:00", comments="Source field: INNODB_TABLESPACES.SERVER_VERSION")
    public static final SqlColumn<String> serverVersion = innodbTablespaces.serverVersion;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2949831+08:00", comments="Source field: INNODB_TABLESPACES.SPACE_VERSION")
    public static final SqlColumn<Integer> spaceVersion = innodbTablespaces.spaceVersion;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2949831+08:00", comments="Source field: INNODB_TABLESPACES.ENCRYPTION")
    public static final SqlColumn<String> encryption = innodbTablespaces.encryption;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2949831+08:00", comments="Source field: INNODB_TABLESPACES.STATE")
