...
public final class InnodbForeignColsDynamicSqlSupport {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2239187+08:00", comments="Source field: INNODB_FOREIGN_COLS.ID")
    public static final SqlColumn<String> id = innodbForeignCols.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2239187+08:00", comments="Source field: INNODB_FOREIGN_COLS.FOR_COL_NAME")
    public static final SqlColumn<String> forColName = innodbForeignCols.forColName;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2239187+08:00", comments="Source field: INNODB_FOREIGN_COLS.REF_COL_NAME")
    public static final SqlColumn<String> refColName = innodbForeignCols.refColName;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2239187+08:00", comments="Source field: INNODB_FOREIGN_COLS.POS")
