...
import static com.fsteam.fsmall.mapper.XIoGlobalByWaitByBytesDynamicSqlSupport.*;

import com.fsteam.fsmall.model.XIoGlobalByWaitByBytes;
...
public interface XIoGlobalByWaitByBytesMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    ...
    int insert(InsertStatementProvider<XIoGlobalByWaitByBytes> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("XIoGlobalByWaitByBytesResult")
    Optional<XIoGlobalByWaitByBytes> selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="XIoGlobalByWaitByBytesResult", value = {
        ...
        @Result(column="total_requested", property="totalRequested", jdbcType=JdbcType.BIGINT)
    })
    List<XIoGlobalByWaitByBytes> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, XIoGlobalByWaitByBytes, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, XIoGlobalByWaitByBytes, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    default int insert(XIoGlobalByWaitByBytes record) {
        return MyBatis3Utils.insert(this::insert, record, XIoGlobalByWaitByBytes, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    default int insertSelective(XIoGlobalByWaitByBytes record) {
        return MyBatis3Utils.insert(this::insert, record, XIoGlobalByWaitByBytes, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    default Optional<XIoGlobalByWaitByBytes> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, XIoGlobalByWaitByBytes, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    default List<XIoGlobalByWaitByBytes> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, XIoGlobalByWaitByBytes, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    default List<XIoGlobalByWaitByBytes> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, XIoGlobalByWaitByBytes, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, XIoGlobalByWaitByBytes, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    static UpdateDSL<UpdateModel> updateAllColumns(XIoGlobalByWaitByBytes record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1738739+08:00", comments="Source Table: x$io_global_by_wait_by_bytes")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(XIoGlobalByWaitByBytes record, UpdateDSL<UpdateModel> dsl) {
