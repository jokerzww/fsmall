...
import static com.fsteam.fsmall.mapper.UserSummaryDynamicSqlSupport.*;

import com.fsteam.fsmall.model.UserSummary;
...
public interface UserSummaryMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4571314+08:00", comments="Source Table: user_summary")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4561306+08:00", comments="Source Table: user_summary")
    ...
    int insert(InsertStatementProvider<UserSummary> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4561306+08:00", comments="Source Table: user_summary")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("UserSummaryResult")
    Optional<UserSummary> selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4561306+08:00", comments="Source Table: user_summary")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="UserSummaryResult", value = {
    ...
    List<UserSummary> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, userSummary, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4561306+08:00", comments="Source Table: user_summary")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, userSummary, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4561306+08:00", comments="Source Table: user_summary")
    default int insert(UserSummary record) {
        return MyBatis3Utils.insert(this::insert, record, userSummary, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4561306+08:00", comments="Source Table: user_summary")
    default int insertSelective(UserSummary record) {
        return MyBatis3Utils.insert(this::insert, record, userSummary, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4571314+08:00", comments="Source Table: user_summary")
    default Optional<UserSummary> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, userSummary, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4571314+08:00", comments="Source Table: user_summary")
    default List<UserSummary> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, userSummary, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4571314+08:00", comments="Source Table: user_summary")
    default List<UserSummary> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, userSummary, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4571314+08:00", comments="Source Table: user_summary")
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, userSummary, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4571314+08:00", comments="Source Table: user_summary")
    static UpdateDSL<UpdateModel> updateAllColumns(UserSummary record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4571314+08:00", comments="Source Table: user_summary")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(UserSummary record, UpdateDSL<UpdateModel> dsl) {
