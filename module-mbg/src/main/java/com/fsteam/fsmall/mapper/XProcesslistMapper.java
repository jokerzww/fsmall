...
import static com.fsteam.fsmall.mapper.XProcesslistDynamicSqlSupport.*;

import com.fsteam.fsmall.model.XProcesslist;
...
public interface XProcesslistMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3180041+08:00", comments="Source Table: x$processlist")
    ...
    int insert(InsertStatementProvider<XProcesslist> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3180041+08:00", comments="Source Table: x$processlist")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("XProcesslistResult")
    Optional<XProcesslist> selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3180041+08:00", comments="Source Table: x$processlist")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="XProcesslistResult", value = {
    ...
    List<XProcesslist> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, XProcesslist, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3180041+08:00", comments="Source Table: x$processlist")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, XProcesslist, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3180041+08:00", comments="Source Table: x$processlist")
    default int insert(XProcesslist record) {
        return MyBatis3Utils.insert(this::insert, record, XProcesslist, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3180041+08:00", comments="Source Table: x$processlist")
    default int insertSelective(XProcesslist record) {
        return MyBatis3Utils.insert(this::insert, record, XProcesslist, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3190053+08:00", comments="Source Table: x$processlist")
    default Optional<XProcesslist> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, XProcesslist, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3190053+08:00", comments="Source Table: x$processlist")
    default List<XProcesslist> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, XProcesslist, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3190053+08:00", comments="Source Table: x$processlist")
    default List<XProcesslist> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, XProcesslist, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3190053+08:00", comments="Source Table: x$processlist")
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, XProcesslist, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3190053+08:00", comments="Source Table: x$processlist")
    static UpdateDSL<UpdateModel> updateAllColumns(XProcesslist record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.3190053+08:00", comments="Source Table: x$processlist")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(XProcesslist record, UpdateDSL<UpdateModel> dsl) {
