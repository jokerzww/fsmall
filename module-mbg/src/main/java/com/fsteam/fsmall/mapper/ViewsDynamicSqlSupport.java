...
public final class ViewsDynamicSqlSupport {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.5452125+08:00", comments="Source Table: VIEWS")
    public static final Views views = new Views();

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.5452125+08:00", comments="Source field: VIEWS.TABLE_CATALOG")
    public static final SqlColumn<String> tableCatalog = views.tableCatalog;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.5452125+08:00", comments="Source field: VIEWS.TABLE_SCHEMA")
    public static final SqlColumn<String> tableSchema = views.tableSchema;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.5452125+08:00", comments="Source field: VIEWS.TABLE_NAME")
    public static final SqlColumn<String> tableName = views.tableName;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.5452125+08:00", comments="Source field: VIEWS.CHECK_OPTION")
    public static final SqlColumn<String> checkOption = views.checkOption;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.5452125+08:00", comments="Source field: VIEWS.IS_UPDATABLE")
    public static final SqlColumn<String> isUpdatable = views.isUpdatable;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.5452125+08:00", comments="Source field: VIEWS.DEFINER")
    public static final SqlColumn<String> definer = views.definer;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.546214+08:00", comments="Source field: VIEWS.SECURITY_TYPE")
    public static final SqlColumn<String> securityType = views.securityType;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.546214+08:00", comments="Source field: VIEWS.CHARACTER_SET_CLIENT")
    public static final SqlColumn<String> characterSetClient = views.characterSetClient;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.546214+08:00", comments="Source field: VIEWS.COLLATION_CONNECTION")
    public static final SqlColumn<String> collationConnection = views.collationConnection;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.546214+08:00", comments="Source field: VIEWS.VIEW_DEFINITION")
