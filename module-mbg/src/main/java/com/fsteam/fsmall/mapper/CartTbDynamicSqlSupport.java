...
public final class CartTbDynamicSqlSupport {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4481229+08:00", comments="Source field: cart_tb.mall_id")
    public static final SqlColumn<String> mallId = cartTb.mallId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4481229+08:00", comments="Source field: cart_tb.customer_id")
    public static final SqlColumn<String> customerId = cartTb.customerId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4481229+08:00", comments="Source field: cart_tb.item_id")
    public static final SqlColumn<Integer> itemId = cartTb.itemId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4481229+08:00", comments="Source field: cart_tb.number")
