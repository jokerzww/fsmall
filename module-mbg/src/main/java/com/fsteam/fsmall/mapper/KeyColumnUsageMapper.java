...
import static com.fsteam.fsmall.mapper.KeyColumnUsageDynamicSqlSupport.*;

import com.fsteam.fsmall.model.KeyColumnUsage;
...
public interface KeyColumnUsageMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.4080878+08:00", comments="Source Table: KEY_COLUMN_USAGE")
    ...
    @Results(id="KeyColumnUsageResult", value = {
        ...
        @Result(column="POSITION_IN_UNIQUE_CONSTRAINT", property="positionInUniqueConstraint", jdbcType=JdbcType.INTEGER),
