...
import static com.fsteam.fsmall.mapper.XHostSummaryByStatementTypeDynamicSqlSupport.*;

import com.fsteam.fsmall.model.XHostSummaryByStatementType;
...
public interface XHostSummaryByStatementTypeMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    BasicColumn[] selectList = BasicColumn.columnList(host, statement, total, totalLatency, maxLatency, lockLatency, rowsSent, rowsExamined, rowsAffected, fullScans);
    ...
    int insert(InsertStatementProvider<XHostSummaryByStatementType> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("XHostSummaryByStatementTypeResult")
    Optional<XHostSummaryByStatementType> selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="XHostSummaryByStatementTypeResult", value = {
    ...
    List<XHostSummaryByStatementType> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, XHostSummaryByStatementType, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, XHostSummaryByStatementType, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    default int insert(XHostSummaryByStatementType record) {
        return MyBatis3Utils.insert(this::insert, record, XHostSummaryByStatementType, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    default int insertSelective(XHostSummaryByStatementType record) {
        return MyBatis3Utils.insert(this::insert, record, XHostSummaryByStatementType, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    default Optional<XHostSummaryByStatementType> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, XHostSummaryByStatementType, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    default List<XHostSummaryByStatementType> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, XHostSummaryByStatementType, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    default List<XHostSummaryByStatementType> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, XHostSummaryByStatementType, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, XHostSummaryByStatementType, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    static UpdateDSL<UpdateModel> updateAllColumns(XHostSummaryByStatementType record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.2899796+08:00", comments="Source Table: x$host_summary_by_statement_type")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(XHostSummaryByStatementType record, UpdateDSL<UpdateModel> dsl) {
