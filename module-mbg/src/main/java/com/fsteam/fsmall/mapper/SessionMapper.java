...
import static com.fsteam.fsmall.mapper.SessionDynamicSqlSupport.*;

import com.fsteam.fsmall.model.Session;
...
public interface SessionMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1628632+08:00", comments="Source Table: session")
    ...
    int insert(InsertStatementProvider<Session> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1628632+08:00", comments="Source Table: session")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("SessionResult")
    Optional<Session> selectOne(SelectStatementProvider selectStatement);
    ...
    @Results(id="SessionResult", value = {
        ...
        @Result(column="last_statement_latency", property="lastStatementLatency", jdbcType=JdbcType.VARCHAR),
        ...
        @Result(column="trx_latency", property="trxLatency", jdbcType=JdbcType.VARCHAR),
    ...
    List<Session> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, session, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1628632+08:00", comments="Source Table: session")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, session, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1628632+08:00", comments="Source Table: session")
    default int insert(Session record) {
        return MyBatis3Utils.insert(this::insert, record, session, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1628632+08:00", comments="Source Table: session")
    default int insertSelective(Session record) {
        return MyBatis3Utils.insert(this::insert, record, session, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1628632+08:00", comments="Source Table: session")
    default Optional<Session> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, session, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1628632+08:00", comments="Source Table: session")
    default List<Session> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, session, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1628632+08:00", comments="Source Table: session")
    default List<Session> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, session, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1628632+08:00", comments="Source Table: session")
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, session, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1628632+08:00", comments="Source Table: session")
    static UpdateDSL<UpdateModel> updateAllColumns(Session record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1628632+08:00", comments="Source Table: session")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(Session record, UpdateDSL<UpdateModel> dsl) {
