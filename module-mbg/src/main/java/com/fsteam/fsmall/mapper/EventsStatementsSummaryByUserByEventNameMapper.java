...
import static com.fsteam.fsmall.mapper.EventsStatementsSummaryByUserByEventNameDynamicSqlSupport.*;

import com.fsteam.fsmall.model.EventsStatementsSummaryByUserByEventName;
...
public interface EventsStatementsSummaryByUserByEventNameMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    BasicColumn[] selectList = BasicColumn.columnList(user, eventName, countStar, sumTimerWait, minTimerWait, avgTimerWait, maxTimerWait, sumLockTime, sumErrors, sumWarnings, sumRowsAffected, sumRowsSent, sumRowsExamined, sumCreatedTmpDiskTables, sumCreatedTmpTables, sumSelectFullJoin, sumSelectFullRangeJoin, sumSelectRange, sumSelectRangeCheck, sumSelectScan, sumSortMergePasses, sumSortRange, sumSortRows, sumSortScan, sumNoIndexUsed, sumNoGoodIndexUsed);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.1348373+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    ...
    int insert(InsertStatementProvider<EventsStatementsSummaryByUserByEventName> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("EventsStatementsSummaryByUserByEventNameResult")
    Optional<EventsStatementsSummaryByUserByEventName> selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="EventsStatementsSummaryByUserByEventNameResult", value = {
    ...
    List<EventsStatementsSummaryByUserByEventName> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, eventsStatementsSummaryByUserByEventName, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, eventsStatementsSummaryByUserByEventName, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    default int insert(EventsStatementsSummaryByUserByEventName record) {
        return MyBatis3Utils.insert(this::insert, record, eventsStatementsSummaryByUserByEventName, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    default int insertSelective(EventsStatementsSummaryByUserByEventName record) {
        return MyBatis3Utils.insert(this::insert, record, eventsStatementsSummaryByUserByEventName, c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    default Optional<EventsStatementsSummaryByUserByEventName> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, eventsStatementsSummaryByUserByEventName, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    default List<EventsStatementsSummaryByUserByEventName> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, eventsStatementsSummaryByUserByEventName, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    default List<EventsStatementsSummaryByUserByEventName> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, eventsStatementsSummaryByUserByEventName, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, eventsStatementsSummaryByUserByEventName, completer);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    static UpdateDSL<UpdateModel> updateAllColumns(EventsStatementsSummaryByUserByEventName record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-01-29T00:44:41.135838+08:00", comments="Source Table: events_statements_summary_by_user_by_event_name")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(EventsStatementsSummaryByUserByEventName record, UpdateDSL<UpdateModel> dsl) {
